        ...
        <div>
            ...
            <header id="header" className="d-flex flex-column justify-content-center">
                    ...
                    <Nav className="flex-column nav-menu">
                            <NavLink href="#hero" className="item active"><i className='bx bx-home'></i><span className="text">Home</span></NavLink>
                            ...
                            <NavLink href="#about" className="item"><i className='bx bx-book-content'></i><span className="text">Portfolio</span></NavLink>
